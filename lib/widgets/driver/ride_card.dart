  ...
  void _initializeMapData() {
    ...
    markers = {
      Marker(
        ...
        position: points.isNotEmpty ? points.first : const LatLng(6.9271, 79.8612),
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
        infoWindow: InfoWindow(title: 'Start: ${widget.ride.pickupLocation}'),
      ),
      Marker(
        markerId: const MarkerId('end'),
        position: points.isNotEmpty ? points.last : const LatLng(6.9271, 79.8612),
        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen),
        infoWindow: InfoWindow(title: 'End: ${widget.ride.dropoffLocation}'),
      ),
      ...waypoints.asMap().entries.map((entry) {
        ...
        return const Marker(markerId: MarkerId('empty'), position: LatLng(0, 0));
            ...
            SizedBox(
              ...
              child: GoogleMap(
                ...
                initialCameraPosition: CameraPosition(
                  target: widget.ride.route.polyline.isNotEmpty
