...
class RideListScreen extends StatelessWidget {
  ...
  Future<void> _bookRide(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final driverToken = ride['driverToken']; // Assume this is in the ride data
        if (driverToken != null) {
  ...
  Future<void> _sendNotificationToDriver(String driverToken, String rideId) async {
    const String fcmUrl = 'https://fcm.googleapis.com/fcm/send';
    const String serverKey =
        'YOUR_FCM_SERVER_KEY'; // Replace with your FCM server key from Firebase Console

    final body = {
      'to': driverToken,
      'notification': {
        'title': 'New Ride Booking',
        'body': 'A passenger has booked your ride (ID: $rideId) at 06:20 PM today!',
      },
      'data': {
